...
from model_tsakt_linear_rope import TSAKT_Linear_RoPE
from utils import *
...
def main(args):
    ...
    print(f"Training TSAKT-Linear (RoPE Positional Encoding) on {args.dataset}")
    ...
    # Create model WITH RoPE positional encoding
    model = TSAKT_Linear_RoPE(num_items, num_skills, embed_size=args.embed_size,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--savedir', type=str, default='save/tsakt-linear-rope')
