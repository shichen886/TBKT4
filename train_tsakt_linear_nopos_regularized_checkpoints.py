...
def main(args):
    ...
    checkpoints_dir = os.path.join(args.savedir, 'checkpoints')
    os.makedirs(checkpoints_dir, exist_ok=True)
    
    # Training loop
    print(f'\nTraining for {args.num_epochs} epochs...')
    print(f'Increased regularization: dropout={args.drop_prob}, weight_decay={args.weight_decay}')
    print(f'Saving checkpoints for each epoch to: {checkpoints_dir}')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train TSAKT-Linear-NoPos with Increased Regularization and Checkpoint Saving')
    parser.add_argument('--dataset', type=str, default='assistments17_long_200')
