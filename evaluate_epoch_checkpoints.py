...
from train_tsakt_linear_rope_qk_regularized_checkpoints import KTDataset, collate_fn, validate
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate different epoch checkpoints on test set')
