...
from model_tsakt_linear_gate import TSAKT_Linear_Gate
from utils import *
...
def main(args):
    ...
    print(f"Training TSAKT-Linear (Gate Fusion Positional Encoding) on {args.dataset}")
    ...
    # Create model WITH Gate fusion positional encoding
    model = TSAKT_Linear_Gate(num_items, num_skills, embed_size=args.embed_size,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--savedir', type=str, default='save/tsakt-linear-gate')
